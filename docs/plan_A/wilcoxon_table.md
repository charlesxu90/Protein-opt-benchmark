...
- No single extension reliably improves over the AlphaVariant base across all 4 landscapes.
- Per-landscape improvements with the best-mean extension at n=30:
  - TEV: +PLM-reward Δ ≈ +0.038, p ≈ 0.34
  - GB1: +PLM-reward Δ ≈ +0.012, p ≈ 0.83
  - PhoQ: +SHAP Δ ≈ +0.022, p ≈ 0.74
  - TRPB: +Hybrid Δ ≈ +0.020, p ≈ 0.32
- None reach α = 0.10. The base AlphaVariant configuration is therefore shipped as the canonical method; extensions are documented as exploratory options for future investigation on landscape-specific deployments.
