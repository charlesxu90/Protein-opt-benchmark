...
METHOD_LOCATIONS = {
    ...
    "AiCE":        ["AiCE/results/{dataset}_AiCE_experiments/{dataset}/aice/metrics_seed{seed}.json"],
    "ALDE":        ["ALDE/results/{dataset}_TS_experiments/{dataset}/onehot/metrics_seed{seed}.json"],
    "FLEXS":       ["FLEXS/results/{dataset}_AdaLead_experiments/{dataset}/metrics_seed{seed}.json"],
