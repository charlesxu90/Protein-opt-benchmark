...
Usage:
    ALDE/env/bin/python scripts/Random/run_generic.py --dataset 4site_GB1 --seed 42
    ALDE/env/bin/python scripts/Random/run_generic.py --dataset 4site_GB1 --seeds 42 123 456
    ALDE/env/bin/python scripts/Random/run_generic.py --dataset 4site_TRPB --seed_file rand_seeds.txt --num_seeds 30
"""
